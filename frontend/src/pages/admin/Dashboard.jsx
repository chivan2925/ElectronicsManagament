  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        ...
        <button className="rounded-lg border border-border bg-white px-4 py-2 text-sm font-bold text-slate-700 shadow-admin-card transition outline-none hover:border-primary hover:text-primary focus-visible:ring-2 focus-visible:ring-blue-200 focus-visible:ring-offset-2 focus-visible:ring-offset-white">
          Xuất báo cáo
        </button>
      </div>
