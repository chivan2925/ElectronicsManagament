      ...
      <div className="page-container">
        <div className="flex items-center gap-3 py-3 lg:gap-4 lg:py-4">
          ...
          <nav className="ml-auto flex items-center gap-2 text-sm">
            ...
            <a className="premium-transition relative flex h-11 items-center gap-2 rounded-xl border border-white/10 bg-white/[0.06] px-3 font-bold text-white shadow-inner shadow-white/[0.03] hover:-translate-y-0.5 hover:border-blue-300/80 hover:bg-blue-500/10 hover:shadow-[0_0_30px_rgba(0,91,255,0.24)]" href="/cart">
