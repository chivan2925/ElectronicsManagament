...
function PromoCard({ promo }) {
  return (
    <MotionArticle className={`premium-transition group relative isolate overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br ${promo.gradient} p-3 shadow-xl shadow-black/24 backdrop-blur-xl hover:-translate-y-1 hover:border-blue-300/60 hover:shadow-[0_0_38px_rgba(0,91,255,0.26),0_24px_60px_rgba(0,0,0,0.34)] sm:p-4`} variants={{ ...fadeUp, hover: hoverGlow }} whileHover="hover">
