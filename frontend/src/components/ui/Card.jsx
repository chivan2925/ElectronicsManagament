...
const variantClasses = {
  ...
  flash:
    "transition-default rounded-2xl border border-blue-400/30 bg-[radial-gradient(circle_at_50%_0%,rgba(0,91,255,0.32),transparent_42%),linear-gradient(150deg,rgba(0,91,255,0.24),#07111F_42%,#050B14_100%)] p-5 shadow-[0_0_42px_rgba(0,91,255,0.2),0_28px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl hover:border-blue-300/60 hover:shadow-[0_0_56px_rgba(0,91,255,0.28),0_28px_80px_rgba(0,0,0,0.38)]",
